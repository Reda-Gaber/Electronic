      ...
      <div className="flex flex-1 flex-col print:block">
        ...
        <header className="flex h-16 items-center justify-between gap-4 border-b border-outline-variant bg-surface-container-lowest px-6 print:hidden">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* بروفايل الأدمن الحالي (من بيانات تسجيل الدخول الفعلية) */}
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium text-on-surface-variant transition-colors hover:bg-error-container hover:text-error"
